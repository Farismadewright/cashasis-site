---
title: "Selling an Inherited House in Harris County: A Plain Guide"
description: "Inherited a house in Houston and not sure what to do? Here's how probate, taxes, and selling as-is actually work in Harris County, step by step."
pubDate: 2026-06-12
author: "CashAsIs"
...
faq:
  ...
  - q: "Do I owe taxes when I sell an inherited house in Texas?"
    a: "Texas has no state inheritance tax. Inherited property usually gets a stepped-up basis to its value on the date of death, which often means little or no capital gains tax if you sell soon after. Confirm your exact situation with a CPA."
  - q: "What if multiple heirs own the house and don't agree?"
    a: "All heirs on title generally have to agree to sell, or the matter goes through the probate court. A cash sale can simplify things because there's one clear number and timeline for everyone to weigh, instead of a drawn-out listing."
---
...
- **Property taxes keep running.** An empty inherited house still owes Harris County property tax every year. If it's been sitting, check for any delinquency at the [Harris County Tax Office](https://www.hctax.net/Property/DelinquentTax). Unpaid taxes come out of the sale, but they don't stop you from selling.
- **Verify what the county has on record.** You can look up the property's details and owner of record on [HCAD](https://search.hcad.org/).
...
1. Find out if the estate has gone through (or started) probate.
2. Pull the property's tax status so there are no surprises.
3. Decide whether you want to deal with repairs and a listing — or sell it as-is and be done.
